...
public class Banco {
    ...
    private static Contas[] contas = new Contas[20];
    ...
    private static Contas buscarConta(String identificador, String senha) {
    ...
    private static void consultarSaldo() {
        ...
        System.out.print("Senha: ");
        String senha = ler.next();
        Contas conta = buscarConta(identificador, senha);
        if (conta != null) {
